    ...
    <form  action="#" method="post" class="am-form am-form-horizontal">
        <div class="am-form-group" style="text-align:center">
            ...
            if (isset($_SESSION['islogin'])) {
                // 若已经登录
                echo "你好! ".$_SESSION['username']. ' ,欢迎来到个人中心! <a href="../controller/logout.php" >|点击注销|</a><br>';
            } else {
                // 若没有登录
        ...
        <div class="am-form-group"></div>
        <div class="am-form-group">
            <a href="../controller/logout.php"><button type="button" class="am-u-sm-12 am-btn am-btn-primary  am-round">退出登录</button></a>
        </div>
